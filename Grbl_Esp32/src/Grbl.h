...
const char* const CNC_VERSION        = "3.10.0_Servo";
const char* const CNC_VERSION_BUILD  = "20260226";
...
ExecAlarm limitsCheckDirection(float* target);  // weak in Limits.cpp; true if out of range
