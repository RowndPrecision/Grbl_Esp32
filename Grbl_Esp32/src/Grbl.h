...
const char* const CNC_VERSION        = "3.5.5_S";
const char* const CNC_VERSION_BUILD  = "20250403";
...
bool limitsCheckDirection(float* target);  // weak in Limits.cpp; true if out of range
