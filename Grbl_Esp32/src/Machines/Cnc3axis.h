...
#define DEFAULT_INVERT_LIMIT_PINS 0 // uint8_t
...
#define DEFAULT_Y_HOMING_MPOS 3.0 // mm
...
#define DEFAULT_Y_STEPS_PER_MM 1600.0   // steps per mm
...
#define DEFAULT_Z_MAX_TRAVEL 50.0  // This is percent in servo mode...used for calibration
